  	...
  	public class Gate extends Sprite implements GameObject
  	{
		...
		public function update(deltaTime:Number):void
		{
			...
			else
			{
				...
				storedEnemies = 2 + GlobalState.currentWave * 2;
			}
		}
		
		public function spawnEnemy():void
		{
			var enemy:Enemy = new Enemy(100 * powerMultiplier, new Point(x, y), (new Path4D()).copyPath(path), currentId);
